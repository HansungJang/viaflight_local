...
//	@Query("SELECT a FROM AirportEventsDBFrame a WHERE a.layoverAirportId = :layoverAirportId AND a.openTime <= :layoverArrivalTime AND a.closeTime >= :layoverArrivalTime")
