...
//	@Query("SELECT a FROM MealOptionsDBFrame a WHERE a.layoverAirportId = :layoverAirportId AND a.openTime <= :layoverArrivalTime AND a.closeTime >= :layoverArrivalTime")
